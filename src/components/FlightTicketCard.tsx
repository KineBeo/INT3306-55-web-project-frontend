              ...
              <ModalBody>
                {isOPenCancel ? (
                  <div className="flex flex-col gap-4">
                    <h4 className="text-lg font-semibold text-gray-800 mb-4">Refund Calculation</h4>
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        <p className="text-gray-600">Original Ticket Price</p>
                      ...
                      {flightTicket.passengers.map((passenger, index) => (
                        <div key={index} className="flex flex-col gap-1">
                          ...
                          <div className="pl-6 flex flex-col gap-1">
                            ...
                            <p className="text-gray-600">{passenger.gender}</p>
                            <p className="text-gray-600">{passenger.dob}</p>
                            {index < flight.adults && <p className="text-gray-600">{passenger.phone}</p>}
                          </div>
                        </div>
                      ))}
                    </div>
